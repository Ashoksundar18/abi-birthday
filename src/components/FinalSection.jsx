      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <ThreeDCard depth={35}>
          <motion.div
            ...
            className="glass-card rounded-3xl p-8 sm:p-14 relative overflow-hidden border-2 border-purple-400/30 shadow-2xl shadow-purple-950/80 flex flex-col items-center"
          >
            ...
            <motion.p
              ...
              className="text-lg sm:text-2xl font-serif text-purple-200/90 italic max-w-xl font-light relative z-10"
            >
        ...
        >
          <a
            href="#"
            onClick={scrollToTop}
            className="inline-flex items-center gap-3 px-9 py-4 rounded-full bg-gradient-to-r from-purple-600 via-pink-500 to-amber-400 text-white font-heading font-semibold text-base sm:text-lg shadow-xl shadow-purple-900/40 hover:shadow-pink-500/60 hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer border border-white/30 group relative z-30 pointer-events-auto select-none ring-2 ring-white/20"
          >
