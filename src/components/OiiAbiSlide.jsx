    ...
    <section id="oii-abi-slide" className="relative min-h-screen flex items-center justify-center py-24 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center w-full">
        <ThreeDCard depth={55}>
          ...
          >
            {/* 100% BRIGHT CRYSTAL CLEAR BACKGROUND PHOTO - ALIGNED SO FACE IS FULLY UNCOVERED */}
            ...
            <div className="relative z-10 w-full flex flex-col items-center pt-2">
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-black/75 border border-pink-400/70 text-pink-200 text-xs font-semibold uppercase tracking-widest mb-4 backdrop-blur-md shadow-xl">
              ...
              <motion.div
                ...
                className="inline-block px-6 py-2 rounded-2xl bg-black/60 border border-pink-400/50 backdrop-blur-md shadow-2xl"
              >
            ...
            <div className="relative z-10 w-full flex flex-col items-center pb-2">
              <div className="bg-black/70 backdrop-blur-md border border-white/30 p-5 sm:p-6 rounded-2xl max-w-xl mx-auto mb-6 shadow-2xl">
                <p className="text-lg sm:text-2xl font-serif italic text-amber-100 font-light drop-shadow-md leading-snug">
