          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <img
                ...
                className="w-full h-full object-cover object-center opacity-85 scale-105 group-hover:scale-110 transition-transform duration-1000 pointer-events-none select-none"
              />
              {/* Soft Subtle Overlay for crisp text contrast */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b0a10] via-[#0b0a10]/50 to-[#0b0a10]/30" />
            </div>

            {/* CARD FOREGROUND CONTENT WITH GLASS PROTECTION */}
            <div className="relative z-10 w-full flex flex-col items-center">
              {/* Subtle Ambient Top Tag */}
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-black/60 border border-pink-400/60 text-pink-200 text-xs font-semibold uppercase tracking-widest mb-8 backdrop-blur-md shadow-lg shadow-pink-500/20">
              ...
              <motion.div
                ...
                className="mb-8"
              >
                <h2 className="font-handwriting text-6xl sm:text-8xl md:text-[9.5rem] font-extrabold text-gradient-romantic tracking-wide drop-shadow-[0_8px_20px_rgba(0,0,0,0.95)] leading-none">
                  oii Abi... ✨
                </h2>
              </motion.div>
            </div>
            ...
            <div className="relative z-10 w-full flex flex-col items-center">
              <div className="bg-black/50 backdrop-blur-md border border-white/20 p-6 sm:p-8 rounded-2xl max-w-xl mx-auto mb-8 shadow-xl">
