      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <ThreeDCard depth={50}>
          <motion.div
            ...
            className="rounded-3xl p-8 sm:p-16 relative overflow-hidden text-center border-2 border-purple-400/60 shadow-2xl shadow-purple-950/90 min-h-[520px]"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center mb-6">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/60 border border-purple-400/60 text-purple-200 text-xs font-semibold uppercase tracking-widest backdrop-blur-md shadow-xl">
              ...
              <div className="mb-8">
                <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/60 border border-white/30 text-xs text-gray-200 font-mono backdrop-blur-md shadow-md">
              ...
              <Quote className="w-10 h-10 text-purple-300 mx-auto mb-6 drop-shadow-[0_4px_12px_rgba(0,0,0,1)]" />

              {/* Heartfelt Text Paragraphs Floating Directly Over Background (NO DARK BOX HIDING FACE) */}
              <div className="space-y-6 text-lg sm:text-2xl font-medium text-white leading-relaxed font-sans max-w-2xl mx-auto">
                {friendData.intro.textParagraphs.map((paragraph, index) => (
                  <motion.p
                    ...
                    className={`drop-shadow-[0_4px_16px_rgba(0,0,0,1)] ${
                      index === friendData.intro.textParagraphs.length - 1 
                        ? "text-amber-200 font-normal pt-2 text-xl sm:text-3xl font-heading" 
              ...
              {/* Bottom Accent Icon */}
              <div className="mt-12 flex items-center justify-center gap-3 text-purple-300 drop-shadow-[0_4px_12px_rgba(0,0,0,1)]">
